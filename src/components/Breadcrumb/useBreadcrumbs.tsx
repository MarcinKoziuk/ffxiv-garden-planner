...
const render = ({
    ...
    const componentProps = {
        ...
        section,
        key: match.pathname,
        isDefault: typeof Breadcrumb === 'string',
        ...(props ?? {}),
    };
    ...
    return {
        ...
        breadcrumb:
            typeof Breadcrumb === 'string' ? (
                createElement(React.Fragment, { key: componentProps.key }, Breadcrumb)
            ) : (
...
const getDefaultBreadcrumb = ({
    ...
    const match = matchPath(pathSection, pathSection) /* istanbul ignore next: this is hard to mock in jest :( */
...
const getBreadcrumbMatch = ({
    ...
    const getIsPathExcluded = (path: string): boolean => matchPath(path, pathSection) != null;
...
export const useBreadcrumbs = useReactRouterBreadcrumbs
